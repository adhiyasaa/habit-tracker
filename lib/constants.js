...
// Users
export const USERS = [
  { id: "tsalysa", name: "Picil", emoji: "👩", color: "from-teal-500 to-emerald-450", nickname: "picil" },
  { id: "dias", name: "Bebe", emoji: "👨", color: "from-blue-500 to-indigo-500", nickname: "bebe" },
];

// Moods pas ngelakuin kegiatan
export const MOODS = [
  { id: "hepi", label: "Happy 🥰", emoji: "🥰", color: "text-rose-500 bg-rose-50 border-rose-200" },
  { id: "capek_hepi", label: "Capeee 🥵", emoji: "🥵", color: "text-orange-500 bg-orange-50 border-orange-200" },
  { id: "males", label: "Males pol 😴", emoji: "😴", color: "text-blue-500 bg-blue-50 border-blue-200" },
  { id: "semangat", label: "Super Motivatedd! 🔥", emoji: "🔥", color: "text-red-500 bg-red-50 border-red-200" },
];

// Tingkat keseruan/kesulitan kegiatan
export const DIFFICULTIES = [
  { id: "enteng", label: "EZ 🌟", emoji: "🌟", color: "text-yellow-600 bg-yellow-50 border-yellow-200" },
  { id: "lumayan", label: "Lumayan lah ⚡", emoji: "⚡", color: "text-purple-600 bg-purple-50 border-purple-200" },
  { id: "perjuangan", label: "Hard Game Anjay! 🏆", emoji: "🏆", color: "text-emerald-600 bg-emerald-50 border-emerald-200" },
];
